...
{
    public partial class Delete_Match : System.Web.UI.Page
    {
        ...
        protected void DeleteMatch(object sender, EventArgs e)
        {
            ...
            string hostClubNamee = HostClub.Text;
            string guestClubName = GuestClub.Text;
            ...
            else
            {
                ...
                SqlCommand loginProc = new SqlCommand("deleteMatch2", conn);
